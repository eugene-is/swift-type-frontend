...
export const Statistics = ({ icon: Icon = null, name = '', value = '', first = false, last = false }) => {
  const indicatorsClassName = `${styles.indicators} ${first ? styles.first : ''} ${last ? styles.last : ''}`;
