...
import { Btn, Statistics, TypewriterText } from '../';
	...
	return (
		<>
			<h2 className={styles.title}>
				<TypewriterText text={'Тренировка завершена'} />
			</h2>
			...
			{!isAuth ? (
				<>
					<h2 className={styles.text}>
						Чтобы записать тренировку необходимо быть авторизованным
					</h2>
				</>
			) : (
				<></>
